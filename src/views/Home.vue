    ...
    <section id="model">
      ...
      <vs-card type="1">
        ...
        <template #interactions>
          <vs-tooltip>
            <vs-button @click="webcamState()" primary icon>
              <b
      ...
      <vs-button @click="openNotification('bottom-center')">
        What's this?
      </vs-button>
...
export default {
  ...
  methods: {
    ...
    openNotification(position = null, duration = "none") {
      this.$vs.notification({
        position,
        duration,
        title: "Sit Stand Right v0.1",
        text: `Aplikacja AI do pilnowania wyprostowanej sylwetki przy pracy.`,
      });
    },
  },
  computed: {
